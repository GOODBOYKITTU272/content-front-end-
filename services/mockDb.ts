import { Project, Role, TaskStatus, User, WorkflowStage, Channel, ProjectData, UserStatus, SystemLog, Priority } from '../types';
...
const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    current_stage: WorkflowStage.FINAL_REVIEW_L2,
    assigned_to_role: Role.CEO,
    status: TaskStatus.WAITING_APPROVAL,
    priority: 'NORMAL',
...
class MockDb {
  ...
  createProject(title: string, channel: Channel, dueDate: string): Project {
  ...
  private isApprovalStage(stage: WorkflowStage): boolean {
    return [
        ...
        WorkflowStage.FINAL_REVIEW_L1, 
        WorkflowStage.FINAL_REVIEW_L2
    ].includes(stage);
  }
}
