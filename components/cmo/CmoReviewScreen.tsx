      ...
      <div className="flex-1 flex flex-col md:flex-row max-w-[1600px] mx-auto w-full">
         ...
         <div className="w-full md:w-[400px] bg-white border-l border-slate-200 p-6 shadow-xl sticky bottom-0 md:top-16 md:h-[calc(100vh-64px)]">
             ...
             <div className="space-y-3 mb-6">
                 ...
                 >
                     <div className="text-left">
                         ...
                         <span className="text-xs opacity-75">Send to CEO for Final Review</span>
                     </div>
                 ...
                 >
                     <div className="text-left">
                         ...
                         <span className="text-xs opacity-75">Return to Writer</span>
                     </div>
             ...
             <button 
                ...
                className={`w-full mt-8 py-4 rounded-xl font-bold text-white shadow-lg transition-all ${
                    decision === 'APPROVE' ? 'bg-blue-600 hover:bg-blue-700' : 
