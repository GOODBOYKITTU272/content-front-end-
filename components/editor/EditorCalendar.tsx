...
import { ChevronLeft, ChevronRight, Film, Calendar as CalendarIconLucide } from 'lucide-react';

interface Props {
    projects: Project[];
}

const EditorCalendar: React.FC<Props> = ({ projects }) => {
                    ...
                    {daysInMonth.map(date => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {delivery && (
                                    <div className="mt-1">
                                        <Film className="w-3 h-3 text-orange-600" />
                                    </div>
                                )}
                            </div>
                        );
